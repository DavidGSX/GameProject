...
func (this *MsgMgr) GenMsgInfo(name string) {
	...
	content = append(content, []byte("	w ISend  // World缩写\n")...)
	...
	content = append(content, []byte("}\n")...)
	content = append(content, []byte("\n")...)
	content = append(content, []byte("func (this *"+name+") Setl(s ISend) {\n")...)
	content = append(content, []byte("	this.l = s\n")...)
	content = append(content, []byte("}\n")...)
	content = append(content, []byte("\n")...)
	content = append(content, []byte("func (this *"+name+") Getl() ISend {\n")...)
	content = append(content, []byte("	return this.l\n")...)
	content = append(content, []byte("}\n")...)
	content = append(content, []byte("\n")...)
	content = append(content, []byte("func (this *"+name+") Setg(s ISend) {\n")...)
	content = append(content, []byte("	this.g = s\n")...)
	content = append(content, []byte("}\n")...)
	content = append(content, []byte("\n")...)
	content = append(content, []byte("func (this *"+name+") Getg() ISend {\n")...)
	content = append(content, []byte("	return this.g\n")...)
	content = append(content, []byte("}\n")...)
	content = append(content, []byte("\n")...)
	content = append(content, []byte("func (this *"+name+") Setw(w ISend) {\n")...)
	content = append(content, []byte("	this.w = w\n")...)
	content = append(content, []byte("}\n")...)
	content = append(content, []byte("\n")...)
	content = append(content, []byte("func (this *"+name+") Getw() ISend {\n")...)
	...
	content = append(content, []byte("}\n")...)
	content = append(content, []byte("\n")...)
	content = append(content, []byte("func (this *"+name+") Send2Link(msg MsgInfo) error {\n")...)
	content = append(content, []byte("	data, err := MarshalMsg(msg)\n")...)
	content = append(content, []byte("	if err != nil {\n")...)
	content = append(content, []byte("		return err\n")...)
	content = append(content, []byte("	}\n")...)
